 ...
 * UserService 인터페이스를 사용하여 Bean 주입받겠다라고 Controller에 선언을 했다
 * 		1. 생성자를 통해서 주입받기
...
public class UserServiceImplV1 implements UserService{
	...
	/*
	 * 최초로 회원가입을 하는 USER는 ADMIN 권한을 부여하고 그 외에는 USER 권한 부여
	 */
	@Override
	public int join(UserVO userVO) {
		/*
		 * 가입 요청한 정보가 최초인지 검사하여 최초로 가입요청을 한 것이면
		 * 현재 사용자의 role 정보를 ADMIN으로 설정한다
		 */
