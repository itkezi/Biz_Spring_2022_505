...
<div class="todo_body w3-card-4">
	<sec:authorize access="isAuthenticated()">
		...
		<c:forEach items="${TODOS}" var="TODO">
			<div data-seq="${TODO.t_seq }" title="시작 : ${TODO.t_sdate},${TODO.t_stime}" class="todo_content w3-border w3-padding-16 w3-margin w3-tooltip">
				${TODO.t_content} <span data-seq="${TODO.t_seq}" class="todo_content w3-text"> (${TODO.t_sdate} ${TODO.t_stime}) </span>
			</div>
		</c:forEach>
		<form:form>
			<input name="t_content" value="t_content" placeholder="TODO Insert" class="w3-input w3-border"/>
		</form:form>
	</sec:authorize>
</div>
