...
<script src="${rootPath}/static/js/input.js?ver=2022-06-08-017"></script>
	...
	<nav>
		<ul>
			...
			<c:if test="${ empty USER}">
				<li class="ma"><a href="${rootPath}/user/login">로그인</a></li>
			...
			<c:if test="${not empty USER}">
				<li class="ma"><a href="${rootPath}/user/mypage">마이페이지(${USER.nickname})</a></li>
