...
<title>books/detail.jsp</title>
</head>
<body>
	<section class="w3-container">
		<div class="w3-conatiner detail-flex">
			<div>
				<img src="${BOOK.image }">
			</div>
			<div class="detail">
		...
		<div class="btn-box">
			<a href="${rootPath}/books/list" class="list">전체목록</a> <a
				href="${rootPath}/books/${BOOK.isbn}/update" class="update">수정</a>
			<%
			// href="javascript:void(0)" : a tag의 link 연결기능 완전 무력화
			%>
