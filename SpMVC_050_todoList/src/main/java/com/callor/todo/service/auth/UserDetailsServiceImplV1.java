...
/*
 * Spring Security에서 지원하는 UserDetailsService 를 상속받아 클래스를 작성한다
 */
...
public class UserDetailsServiceImplV1 implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		/*
		 * 사용자 정보가 DB에 없으면 exception을 발생시켜 Security에게 알리기
		 */
		if(userVO == null ) {
			throw new UsernameNotFoundException( username + " : 없는 사용자입니다. 회원가입 해주세요." );
		}
		...
		// GrantedAuthority 객체 변환된 ROLE 정보를 사용자 정보에 setting
